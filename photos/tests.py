...
class MyGalery_TestCases(TestCase):
    def setUp(self):
        ...
        self.new_image = Image(id=1,image_name='Happiness', image_description='Happy',image_path='/media/photos/wallhaven-w87wx6.jpg',image_category=self.new_category,image_location=self.new_location)
    ...
    def test_delete_method(self):
        self.new_image.save_image()
        filtered_object = Image.objects.filter(image_name='Happiness')
    ...
    def test_display_all_objects_method(self):
        ...
        self.assertEqual(all_objects.image_name,'Happiness')


    def test_update_single_object_property(self):
        self.new_image.save_image()
        filtered_object =Image.update_image('Happiness','Hacking')
        fetched = Image.objects.get(image_name='Hacking')
        self.assertEqual(fetched.image_name,'Hacking')
